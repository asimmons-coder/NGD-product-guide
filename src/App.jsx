...
const products = [
  ...
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sun Protection', 'Makeup Primer', 'Oily Skin'],
    trending: true,
    carriedByNGD: false,
    overview: 'A totally invisible, weightless, scentless sunscreen that doubles as a makeup-gripping primer. Oil-free with a velvety finish.',
    verdict: 'A great option for patients who hate the feel of sunscreen. The primer-like texture makes it easy to layer under makeup. Particularly good for oily skin types who find most sunscreens too greasy.',
  ...
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sun Protection', 'Budget-Friendly', 'Daily Use'],
    trending: false,
    carriedByNGD: false,
    overview: 'A drugstore staple with Helioplex technology for broad-spectrum protection. Lightweight, non-greasy formula at an accessible price point.',
    verdict: 'Proof that effective sun protection does not have to be expensive. The dry-touch finish works well under makeup. A solid everyday option, especially for patients on a budget or who need to apply generously.',
  ...
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sun Protection', 'Sensitive Skin', 'Mineral', 'Eczema'],
    trending: false,
    carriedByNGD: false,
    overview: 'A 100% mineral sunscreen with zinc oxide and titanium dioxide. No chemical filters, fragrances, or parabens. Smart Bottle technology turns blue in UV light.',
    verdict: 'An excellent mineral option for patients who react to chemical sunscreens. The Australian formula meets strict standards. Some white cast on darker skin tones, but the protection is reliable.',
    lastReviewed: '2025-01-12'
  },
  {
    id: 'isntree-hyaluronic-sun',
    name: 'Isntree Hyaluronic Acid Watery Sun Gel SPF 50+',
    category: 'Sunscreen',
    rating: 'recommended',
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sun Protection', 'Hydration', 'K-Beauty', 'Lightweight'],
    trending: true,
    carriedByNGD: false,
    overview: 'A Korean sunscreen with newer UV filters (Tinosorb S and M) not available in US formulations. Lightweight, hydrating gel texture with no white cast.',
    verdict: 'Korean and European sunscreens often use superior UV filters. This one offers excellent UVA protection in an elegant, hydrating formula. Worth importing for patients who want the best in sun protection.',
    lastReviewed: '2025-01-20'
  },
  ...
  {
    id: 'vanicream-moisturizing',
    name: 'Vanicream Moisturizing Skin Cream',
    category: 'Moisturizer',
    rating: 'recommended',
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sensitive Skin', 'Eczema', 'Fragrance-Free', 'Dry Skin'],
    trending: false,
    carriedByNGD: false,
    overview: 'A no-frills moisturizer free of dyes, fragrance, masking fragrance, lanolin, parabens, and formaldehyde. Developed for sensitive skin.',
    verdict: 'The ultimate "boring" moisturizer—and we mean that as a compliment. When patients react to everything, Vanicream is often the answer. Nothing fancy, just reliable hydration without irritation.',
    lastReviewed: '2025-01-10'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sensitive Skin', 'Barrier Repair', 'Niacinamide', 'Daily Use'],
    trending: false,
    carriedByNGD: false,
    overview: 'A ceramide moisturizer with prebiotic thermal water and niacinamide. Restores the skin barrier while calming and hydrating.',
    verdict: 'A well-formulated, accessible option for daily moisturizing. The niacinamide provides additional benefits for redness and uneven tone. A great drugstore alternative to pricier barrier repair creams.',
    lastReviewed: '2025-01-14'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Dry Skin', 'Eczema', 'Sensitive Skin', 'Body Moisturizer'],
    trending: false,
    carriedByNGD: false,
    overview: 'A colloidal oatmeal cream with shea butter, ceramides, and allantoin. Fast-absorbing formula suitable for face and body.',
    verdict: 'Popular for good reason—it absorbs quickly despite being rich enough for very dry skin. The colloidal oatmeal provides anti-itch benefits. Works well for eczema-prone skin on both face and body.',
    lastReviewed: '2025-01-12'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Oily Skin', 'Lightweight', 'Hydration', 'Budget-Friendly'],
    trending: false,
    carriedByNGD: false,
    overview: 'A hyaluronic acid gel-cream that provides hydration without heaviness. Oil-free, non-comedogenic formula.',
    verdict: 'An excellent lightweight option for oily skin types who need hydration but hate heavy creams. The gel texture is refreshing and layers well under other products. Good drugstore value.',
    lastReviewed: '2025-01-08'
  },
  ...
  },
  {
    ...
    ratingLabel: 'Gold Standard',
    evidence: 'Extensive',
    concerns: ['Dry Skin', 'Sensitive Skin', 'Daily Use', 'Barrier Support'],
    trending: false,
    carriedByNGD: false,
    overview: 'A gentle, non-foaming cleanser with ceramides and hyaluronic acid. Removes dirt and makeup without disrupting the skin barrier.',
    verdict: 'The benchmark for gentle cleansing. The ceramide complex actually helps repair the barrier while you cleanse. For most skin types, this is all the cleanser you need. Available everywhere at a great price.',
    lastReviewed: '2025-01-08'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Oily Skin', 'Acne', 'Daily Use', 'Normal Skin'],
    trending: false,
    carriedByNGD: false,
    overview: 'A foaming gel cleanser with ceramides and niacinamide. Removes excess oil without over-stripping.',
    verdict: 'The foaming version for those who prefer that clean feeling. Still gentle enough for daily use and maintains the ceramide benefits. Better for oily and combination skin than the hydrating version.',
    lastReviewed: '2025-01-08'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sensitive Skin', 'Dry Skin', 'Rosacea', 'Daily Use'],
    trending: false,
    carriedByNGD: false,
    overview: 'A milky cleanser with prebiotic thermal water, ceramides, and niacinamide. Designed for sensitive and intolerant skin.',
    verdict: 'An excellent option for reactive skin. The prebiotic thermal water helps maintain a healthy skin microbiome. Particularly good for patients with rosacea who find most cleansers irritating.',
    lastReviewed: '2025-01-12'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Sensitive Skin', 'Eczema', 'Fragrance-Free', 'Allergies'],
    trending: false,
    carriedByNGD: false,
    overview: 'A soap-free, fragrance-free cleanser for sensitive skin. Free of dyes, parabens, and common irritants.',
    verdict: 'When patients say they react to everything, Vanicream is often the answer. No frills, no fancy ingredients—just effective, non-irritating cleansing. A dermatology office staple.',
    lastReviewed: '2025-01-10'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Dry Skin', 'Sensitive Skin', 'K-Beauty', 'Hydrating'],
    trending: true,
    carriedByNGD: false,
    overview: 'A gentle gel-to-foam cleanser with matcha and hemp seed oil. Maintains skin pH and hydration while cleansing.',
    verdict: 'A well-formulated K-beauty cleanser that lives up to the hype. The hemp seed oil provides gentle cleansing without stripping. Good for patients who want something more interesting than basic drugstore options.',
    lastReviewed: '2025-01-18'
  },
  ...
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Anti-Aging', 'Fine Lines', 'Texture', 'Budget-Friendly'],
    trending: false,
    carriedByNGD: false,
    overview: 'A pure retinol in squalane base for improved stability and tolerance. Budget-friendly option for retinoid newcomers.',
    verdict: 'Excellent value for a well-formulated retinol. The squalane base reduces irritation. A great starting point for patients who want to try retinoids without committing to expensive products.',
    lastReviewed: '2025-01-16'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Hyperpigmentation', 'Dark Spots', 'Uneven Tone', 'Budget-Friendly'],
    trending: false,
    carriedByNGD: false,
    overview: 'A tranexamic acid serum with niacinamide for brightening and evening skin tone. Affordable alternative to pricier brightening treatments.',
    verdict: 'Tranexamic acid is gaining recognition for hyperpigmentation treatment. This is an affordable way to try the ingredient. Layer with sunscreen for best results on dark spots.',
    lastReviewed: '2025-01-14'
  },
  {
    id: 'timeless-ce-ferulic',
    name: 'Timeless 20% Vitamin C + E Ferulic Acid Serum',
    category: 'Serum',
    rating: 'recommended',
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Anti-Aging', 'Brightening', 'Antioxidants', 'Budget-Friendly'],
    trending: false,
    carriedByNGD: false,
    overview: 'A vitamin C serum following the Duke Antioxidant Patent formulation at a fraction of the SkinCeuticals price.',
    verdict: 'The closest dupe to SkinCeuticals C E Ferulic. Same key ingredients and pH. Less elegant texture but delivers similar antioxidant benefits. Best kept refrigerated for stability.',
    lastReviewed: '2025-01-12'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Hydration', 'Fine Lines', 'Sensitive Skin', 'Plumping'],
    trending: false,
    carriedByNGD: false,
    overview: 'A hyaluronic acid serum with vitamin B5 (panthenol) and madecassoside. Hydrates and repairs the skin barrier.',
    verdict: 'A solid hyaluronic acid option from a trusted brand. The added vitamin B5 supports skin healing. Well-tolerated by sensitive skin. Good drugstore alternative to pricier HA serums.',
    lastReviewed: '2025-01-10'
  },
  {
    id: 'azelaic-acid',
    name: 'Azelaic Acid (Various Brands)',
    category: 'Serum',
    rating: 'gold',
    ratingLabel: 'Gold Standard',
    evidence: 'Extensive',
    concerns: ['Rosacea', 'Acne', 'Hyperpigmentation', 'Melasma'],
    trending: false,
    carriedByNGD: false,
    overview: 'A dicarboxylic acid with anti-inflammatory, antibacterial, and melanin-inhibiting properties. Available OTC (The Ordinary, Paula\'s Choice) or prescription (Finacea).',
    verdict: 'One of the most underrated skincare ingredients. Strong evidence for rosacea, acne, and hyperpigmentation with minimal irritation. Safe during pregnancy. The Ordinary and Paula\'s Choice offer good OTC options.',
    lastReviewed: '2025-01-20'
  },
  ...
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Dark Circles', 'Puffiness', 'Budget-Friendly', 'Sensitive Skin'],
    trending: false,
    carriedByNGD: false,
    overview: 'A ceramide-based eye cream with niacinamide and hyaluronic acid. Marine and botanical complex helps reduce puffiness.',
    verdict: 'A solid drugstore option for basic eye care needs. The ceramides support the delicate eye area skin barrier. Not as potent as medical-grade options, but a good starting point at an accessible price.',
    lastReviewed: '2025-01-08'
  },
  {
    id: 'roc-retinol-eye',
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Fine Lines', 'Crows Feet', 'Anti-Aging', 'Budget-Friendly'],
    trending: false,
    carriedByNGD: false,
    overview: 'A retinol-based eye cream from a brand with decades of retinol research. Targets fine lines and crow\'s feet.',
    verdict: 'One of the better drugstore retinol eye creams. RoC has genuine research behind their retinol formulations. Start slowly—even eye-specific retinol can cause irritation. Good value for anti-aging on a budget.',
    lastReviewed: '2025-01-10'
  },
  {
    id: 'the-ordinary-caffeine',
    name: 'The Ordinary Caffeine Solution 5% + EGCG',
    category: 'Eye Care',
    rating: 'recommended',
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Puffiness', 'Dark Circles', 'Budget-Friendly'],
    trending: false,
    carriedByNGD: false,
    overview: 'A highly concentrated caffeine serum with EGCG from green tea. Reduces puffiness and appearance of dark circles.',
    verdict: 'At under $10, this is a no-brainer to try for puffiness. Caffeine constricts blood vessels and reduces fluid retention. Apply in the morning for best de-puffing results. Watery texture, so layer under other eye products.',
    lastReviewed: '2025-01-06'
  },
  {
    id: 'olay-eyes-retinol',
    name: 'Olay Eyes Retinol24 Night Eye Cream',
    category: 'Eye Care',
    rating: 'recommended',
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Fine Lines', 'Dark Circles', 'Anti-Aging', 'Drugstore'],
    trending: false,
    carriedByNGD: false,
    overview: 'A retinoid complex eye cream with vitamin B3. Formulated for overnight use to target fine lines and dark circles.',
    verdict: 'A good drugstore option for those who want retinoid benefits around the eyes. Olay\'s retinoid complex is gentler than pure retinol. Decent results for the price point.',
    lastReviewed: '2025-01-12'
  },
  ...
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Acne', 'Oily Skin', 'Post-Acne Marks', 'Daily Use'],
    trending: false,
    carriedByNGD: false,
    overview: 'A dual-action acne treatment with benzoyl peroxide and lipo-hydroxy acid. Targets acne while helping prevent post-acne marks.',
    verdict: 'One of the best drugstore acne treatments. The combination of BP and LHA is effective without being overly drying. Good for maintenance after prescription treatments or for mild-moderate acne.',
    lastReviewed: '2025-01-14'
  },
  {
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Acne', 'Blackheads', 'Oily Skin', 'Daily Use'],
    trending: false,
    carriedByNGD: false,
    overview: 'A 4% benzoyl peroxide cleanser with ceramides and hyaluronic acid. Treats acne while supporting the skin barrier.',
    verdict: 'A unique combination of benzoyl peroxide with barrier-supporting ingredients. Less drying than traditional BP washes. Good for acne-prone skin that also needs hydration support.',
    lastReviewed: '2025-01-10'
  },
  {
    id: 'mighty-patch',
    ...
    ratingLabel: 'Recommended',
    evidence: 'Moderate',
    concerns: ['Spot Treatment', 'Pimples', 'Picking Prevention'],
    trending: true,
    carriedByNGD: false,
    overview: 'Hydrocolloid patches that absorb pus and fluid from pimples overnight. Also creates a physical barrier to prevent picking.',
    verdict: 'These work well for surface-level whiteheads and papules. The hydrocolloid draws out fluid and protects the area. Most importantly, they prevent picking—which is half the battle with acne.',
    lastReviewed: '2025-01-18'
  },
  {
    id: 'panoxyl-10',
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Body Acne', 'Severe Acne', 'Bacteria', 'Back Acne'],
    trending: false,
    carriedByNGD: false,
    overview: 'A maximum-strength 10% benzoyl peroxide cleanser. Particularly effective for body acne where higher concentrations are better tolerated.',
    verdict: 'The go-to for body acne. The 10% concentration is too harsh for most faces but works well on thicker back and chest skin. Leave on for 2-3 minutes before rinsing. Will bleach towels and fabrics.',
    lastReviewed: '2025-01-08'
  },
  {
    id: 'curology-custom',
    ...
    ratingLabel: 'Recommended',
    evidence: 'Strong',
    concerns: ['Acne', 'Prescription', 'Personalized', 'Anti-Aging'],
    trending: false,
    carriedByNGD: false,
    overview: 'A telehealth service providing custom prescription formulas (tretinoin, azelaic acid, niacinamide, etc.) based on your skin concerns.',
    verdict: 'A convenient way to access prescription-strength ingredients. The custom formulation means you get what your skin needs. Good option for patients who want tretinoin but find in-person derm visits difficult.',
    lastReviewed: '2025-01-16'
  },
